...
(function() {
  var AudioContext, analyser, context, e, hue, input, ip, lightSwitch, range, user;
  ...
  $(function() {
    ...
    getFreq = function() {
      ...
      if (volume > range && !lightSwitch) {
        hue.lightTrriger(3, true).then(function(result) {
        ...
        hue.lightTrriger(3, false).then(function(result) {
